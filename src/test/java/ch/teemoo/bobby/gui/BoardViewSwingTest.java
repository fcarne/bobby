...
public class BoardViewSwingTest {
	...
	private static Stream<Arguments> promotionDialog_clickRadioButton_returnChosenPiece() {
		return Stream.of(arguments("queenRadioButton", Queen.class), arguments("rookRadioButton", Rook.class),
				arguments("bishopRadioButton", Bishop.class), arguments("knightRadioButton", Knight.class));
	}
	...
	@Test
	public void loadGameDialog_cancel_returnEmpty() throws InterruptedException, ExecutionException, IOException {
	...
	@Test
	public void saveGameDialog_cancel_returnEmpty() throws InterruptedException, ExecutionException, IOException {
	...
	@ParameterizedTest
	@MethodSource
	public void gameSetupDialog_notExitOnClose_setupHasCorrectPlayers(boolean okOption, boolean timeoutSelected,
			Object timeoutValue, int sliderLevel, boolean openings, boolean white, boolean shouldBeNull,
			Class<?> whitePlayerClass, Class<?> blackPlayerClass) throws InterruptedException, ExecutionException {
		// when
		RunnableFuture<GameSetup> rf = new FutureTask<>(() -> frame.gameSetupDialog(new BotFactory(null, null), false));
		SwingUtilities.invokeLater(rf);
