...
public class GameTest {
	...
	@ParameterizedTest
	@MethodSource
	public void canBePlayed_newGame_returnExpected(Player whitePlayer, Player blackPlayer, GameState state, boolean expected) {
		Game game = new Game(whitePlayer, blackPlayer);
		game.setState(state);
	...
	private static Stream<Arguments> canBePlayed_newGame_returnExpected() {
		...
		return Stream.of(
				arguments(whitePlayer, blackPlayer, GameState.IN_PROGRESS, true),
				arguments(null, blackPlayer, GameState.IN_PROGRESS, false),
				arguments(whitePlayer, null, GameState.IN_PROGRESS, false),
				arguments(whitePlayer, blackPlayer, GameState.LOSS, false));
	}
