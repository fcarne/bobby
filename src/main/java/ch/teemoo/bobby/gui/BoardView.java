...
public class BoardView extends JFrame implements IBoardView {
 ...
 public Optional<File> saveGameDialog() {
  ...
  public GameSetup gameSetupDialog(BotFactory botFactory, boolean exitOnCancel) {
    ...
    int result = JOptionPane.showConfirmDialog(this, inputs, "Game setup",
        JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, logoIcon);
  ...
  private void showAboutDialog() {
    JOptionPane.showMessageDialog(this, "Bobby " + guiHelper.getVersion()
            + " (" + guiHelper.getBuildTimestamp() + ")\n"
            + " \n"
            ...
            + "― Bobby Fischer",
        "About Bobby", JOptionPane.INFORMATION_MESSAGE, logoIcon);
  }
